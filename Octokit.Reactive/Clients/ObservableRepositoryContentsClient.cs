...
namespace Octokit.Reactive
{
    ...
    public class ObservableRepositoryContentsClient : IObservableRepositoryContentsClient
    {
        ...
        /// </returns>
        public IObservable<RepositoryContent> GetAllContentsBypath(string owner, string name, string path)
        {
            Ensure.ArgumentNotNullOrEmptyString(owner, "owner");
            Ensure.ArgumentNotNullOrEmptyString(name, "name");
        ...
        /// A collection of <see cref="RepositoryContent"/> representing the content at the specified path
        /// </returns>
        public IObservable<RepositoryContent> GetAllContentsBypath(string owner, string name, string path, string reference)
        {
            Ensure.ArgumentNotNullOrEmptyString(owner, "owner");
            Ensure.ArgumentNotNullOrEmptyString(name, "name");
            Ensure.ArgumentNotNullOrEmptyString(path, "path");
